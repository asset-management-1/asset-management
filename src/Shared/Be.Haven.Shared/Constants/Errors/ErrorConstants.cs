...
public static class ErrorConstants
{
    ...
    {
        /// <summary>
        /// Message used when backend-owned code generation exhausts all attempts.
        /// </summary>
    ...
    public static class DatabaseErrors
    {
        ...
        /// <summary>
        /// Message used when a row-lock query is invoked without an active database transaction.
        /// </summary>
        ...
        /// <summary>
        /// Message used when a connection name is not supplied.
        /// </summary>
    ...
    {
        /// <summary>
        /// Message used when an OrderBy expression has an invalid format.
        /// </summary>
    ...
    {
        /// <summary>
        /// Client-safe message returned when an upstream service rejects a request.
        /// </summary>
        public const string THIRD_PARTY_SERVICE_ERROR = "The external service could not process the request.";

        /// <summary>
        /// Message used when an outbound request exceeds its timeout.
        /// </summary>
        public const string ERROR_REQUEST_TIMEOUT = "Request timeout after {0}s. Error Message: {1}";

        /// <summary>
        /// Message used when a circuit breaker rejects an outbound request.
        /// </summary>
    ...
    {
        /// <summary>
        /// Message used when a required upload file is missing.
        /// </summary>
        public const string OBJECT_STORAGE_REQUIRED_FILE_MISSING_MESSAGE = "Required upload file is missing.";

        /// <summary>
        /// Message used when a batch upload fails after cleanup is attempted.
        /// </summary>
    ...
    {
        /// <summary>
        /// Message used when Haven token validation options are incomplete.
        /// </summary>
    ...
    public static class EventBusErrors
    {
        ...
        /// <summary>
        /// Message used when an event type is registered more than once.
        /// </summary>
    ...
    {
        /// <summary>
        /// Message used when a signed URL cannot be generated.
        /// </summary>
        public const string SIGNED_URL_FAILED = "Could not generate signed URL";

        /// <summary>
        /// Message used when an object cannot be uploaded.
        /// </summary>
    ...
    {
        /// <summary>
        /// Message used when an Excel report key is not configured.
        /// </summary>

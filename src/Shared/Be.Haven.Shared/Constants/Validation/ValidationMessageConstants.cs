...
/// <summary>
/// Contains reusable validation messages shared by request and model validators.
/// </summary>
public static class ValidationMessage
{
    /// <summary>
    /// Message used when a shared validation target is null.
    /// </summary>
    ...
    /// <summary>
    /// Value must be a canonical E.164 phone number.
    /// Placeholder: {PropertyName}.
    /// </summary>
    public const string INVALID_PHONE_NUMBER = "{PropertyName} must use E.164 format, for example +84901234567.";

...
public static class ObjectStorageConstants
{
    ...
    /// <summary>Validation message returned when optional evidence has no content.</summary>
    public const string EVIDENCE_FILE_EMPTY_MESSAGE = "Evidence file must contain content.";

    /// <summary>Validation message returned when optional evidence exceeds the upload limit.</summary>
    public const string EVIDENCE_FILE_TOO_LARGE_MESSAGE = "Each evidence file must not exceed 10 MB.";

    /// <summary>Validation message returned for unsupported evidence metadata.</summary>
    public const string EVIDENCE_FILE_FORMAT_NOT_SUPPORTED_MESSAGE = "Evidence file must be a supported image or PDF document.";

    /// <summary>Validation message returned when evidence bytes do not match a supported image or PDF document.</summary>
    ...
    /// <summary>
    /// Message used when an upload fails and one or more newly created objects cannot be removed.
    /// </summary>

...
public sealed class UpdateMeterCommandHandlerTests
{
    [Fact]
    public async Task Handle_Should_CallSharedMutationWorkflowWithUpdateMode()
    {
        ...
        var sut = new UpdateMeterCommandHandler(
            meterService.Object,
            partyService.Object,
            Mock.Of<ILogger<UpdateMeterCommandHandler>>());

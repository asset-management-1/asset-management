...
public static class ApplicationLogConstants
{
    ...
    public static class LoginLogs
    {
        ...
        /// </summary>
        public const string LOCAL_LOGIN_FLOW_STEP1_LOCK_CHECKED = "Local login flow Step1: Temporary login lock checked.";

        /// <summary>
        /// Logged after local login credentials are accepted and a token pair is issued.
        /// </summary>
        public const string LOCAL_LOGIN_FLOW_STEP2_CREDENTIALS_ACCEPTED = "Local login flow Step2: Credentials accepted and token pair issued.";

        /// <summary>
        /// Logged after local login clears failed-attempt state following a successful sign-in.
        /// </summary>
        public const string LOCAL_LOGIN_FLOW_STEP3_ATTEMPTS_RESET = "Local login flow Step3: Failed-attempt state reset.";
    ...
    /// <summary>
    /// Contains refresh-token and logout log messages.
    /// </summary>
    ...
    public static class RegisterLogs
    {
        ...
        /// </summary>
        public const string REGISTER_FLOW_STEP1_REQUEST_NORMALIZED = "Register flow Step1: Request normalized and party type validated.";
        ...
        /// </summary>
        public const string REGISTER_FLOW_STEP2_THROTTLE_ACCEPTED = "Register flow Step2: OTP throttle accepted.";

        /// <summary>
        /// Logged after pending registration payload is built for caching.
        /// </summary>
        public const string REGISTER_FLOW_STEP3_PENDING_BUILT = "Register flow Step3: Pending registration payload built.";

        /// <summary>
        /// Logged after the register session cache entry is overwritten.
        /// </summary>
        public const string REGISTER_FLOW_STEP4_SESSION_CACHED = "Register flow Step4: Register session cache overwritten.";

        /// <summary>
        /// Logged after register OTP email is sent successfully.
        /// </summary>
        public const string REGISTER_FLOW_STEP5_OTP_SENT = "Register flow Step5: Register OTP email sent.";
        ...
        /// </summary>
        public const string VERIFY_REGISTER_FLOW_STEP1_SESSION_LOADED = "Verify register flow Step1: Register session loaded.";

        /// <summary>
        /// Logged after register OTP is verified.
        /// </summary>
        public const string VERIFY_REGISTER_FLOW_STEP2_OTP_VERIFIED = "Verify register flow Step2: OTP verified.";

        /// <summary>
        /// Logged after register verification creates the account graph.
        /// </summary>
        public const string VERIFY_REGISTER_FLOW_STEP3_ACCOUNT_CREATED = "Verify register flow Step3: Account graph created.";

        /// <summary>
        /// Logged after register session cache state is removed.
        /// </summary>
        public const string VERIFY_REGISTER_FLOW_STEP4_SESSION_REMOVED = "Verify register flow Step4: Register session state removed.";

        /// <summary>
        /// Logged when an invalid register OTP attempt is stored for retry limiting.
        /// </summary>
        public const string VERIFY_REGISTER_FLOW_OTP_ATTEMPT_RECORDED = "Verify register flow: Failed OTP attempt recorded.";
    ...
    /// <summary>
    /// Contains party-context switch log messages.
    /// </summary>
    ...
    /// <summary>
    /// Contains external identity-provider log messages.
    /// </summary>
    ...
    public static class ForgotPasswordLogs
    {
        ...
        /// </summary>
        public const string FORGOT_PASSWORD_FLOW_STEP1_REQUEST_NORMALIZED = "Forgot-password flow Step1: Request normalized.";
        ...
        /// </summary>
        public const string FORGOT_PASSWORD_FLOW_STEP2_THROTTLE_ACCEPTED = "Forgot-password flow Step2: OTP throttle accepted.";

        /// <summary>
        /// Logged after forgot-password account lookup finishes without exposing whether the account exists.
        /// </summary>
        public const string FORGOT_PASSWORD_FLOW_STEP3_ACCOUNT_LOOKUP_COMPLETED = "Forgot-password flow Step3: Account lookup completed.";
        ...
        /// </summary>
        public const string FORGOT_PASSWORD_FLOW_STEP4_OTP_CACHED = "Forgot-password flow Step4: Reset OTP cached.";

        /// <summary>
        /// Logged after forgot-password OTP email is sent successfully.
        /// </summary>
        public const string FORGOT_PASSWORD_FLOW_STEP5_OTP_SENT = "Forgot-password flow Step5: Forgot-password OTP email sent.";
        ...
        /// </summary>
        public const string VERIFY_FORGOT_PASSWORD_FLOW_STEP1_REQUEST_NORMALIZED = "Verify forgot-password OTP flow Step1: Request normalized.";

        /// <summary>
        /// Logged after forgot-password OTP is verified and consumed.
        /// </summary>
        public const string VERIFY_FORGOT_PASSWORD_FLOW_STEP2_OTP_VERIFIED = "Verify forgot-password OTP flow Step2: OTP verified and consumed.";

        /// <summary>
        /// Logged after forgot-password reset session is opened.
        /// </summary>
        public const string VERIFY_FORGOT_PASSWORD_FLOW_STEP3_RESET_SESSION_CREATED = "Verify forgot-password OTP flow Step3: Reset session created.";

        /// <summary>
        /// Logged when an invalid forgot-password OTP attempt is stored for retry limiting.
        /// </summary>
        public const string VERIFY_FORGOT_PASSWORD_FLOW_OTP_ATTEMPT_RECORDED = "Verify forgot-password OTP flow: Failed OTP attempt recorded.";
        ...
        /// </summary>
        public const string CHANGE_FORGOT_PASSWORD_FLOW_STEP1_RESET_SESSION_VALIDATED = "Change forgot-password flow Step1: Reset session validated.";

        /// <summary>
        /// Logged after forgot-password password change and session revocation complete.
        /// </summary>
        public const string CHANGE_FORGOT_PASSWORD_FLOW_STEP2_PASSWORD_CHANGED = "Change forgot-password flow Step2: Password changed and sessions revoked.";

        /// <summary>
        /// Logged after forgot-password reset session state is consumed.
        /// </summary>
        public const string CHANGE_FORGOT_PASSWORD_FLOW_STEP3_RESET_SESSION_CONSUMED = "Change forgot-password flow Step3: Reset session consumed.";
    ...
    /// <summary>
    /// Contains authenticated password-change log messages.
    /// </summary>
    ...
    /// <summary>
    /// Contains current-user profile log messages.
    /// </summary>
    ...
    public static class ChangeEmailLogs
    {
        ...
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP1_CURRENT_USER_RESOLVED = "Change-email flow Step1: Current user resolved and cooldown cleared.";

        /// <summary>
        /// Logged after the new email is validated and normalized for ownership verification.
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP2_TARGET_PREPARED = "Change-email flow Step2: Target email prepared.";

        /// <summary>
        /// Logged after change-email session cache is overwritten.
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP3_SESSION_CACHED = "Change-email flow Step3: Change-email session cache overwritten.";

        /// <summary>
        /// Logged after change-email OTP is sent to the new email.
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP4_OTP_SENT = "Change-email flow Step4: Change-email OTP sent.";
        ...
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP5_SECURITY_NOTIFICATION_ATTEMPTED = "Change-email flow Step5: Old-email security notification attempted.";

        /// <summary>
        /// Logged after change-email cooldown state is stored.
        /// </summary>
        public const string CHANGE_EMAIL_FLOW_STEP6_COOLDOWN_SET = "Change-email flow Step6: Cooldown stored.";
        ...
        /// </summary>
        public const string VERIFY_CHANGE_EMAIL_FLOW_STEP1_SESSION_VALIDATED = "Verify change-email flow Step1: Change-email session state validated.";

        /// <summary>
        /// Logged after change-email OTP is verified.
        /// </summary>
        public const string VERIFY_CHANGE_EMAIL_FLOW_STEP2_OTP_VERIFIED = "Verify change-email flow Step2: OTP verified.";

        /// <summary>
        /// Logged after the verified new email is persisted.
        /// </summary>
        public const string VERIFY_CHANGE_EMAIL_FLOW_STEP3_EMAIL_UPDATED = "Verify change-email flow Step3: Email updated.";

        /// <summary>
        /// Logged after change-email session cache state and cooldown are removed.
        /// </summary>
        public const string VERIFY_CHANGE_EMAIL_FLOW_STEP4_STATE_CLEANED = "Verify change-email flow Step4: Session state cleaned.";

        /// <summary>
        /// Logged when an invalid change-email OTP attempt is stored for retry limiting.
        /// </summary>
        public const string VERIFY_CHANGE_EMAIL_FLOW_OTP_ATTEMPT_RECORDED = "Verify change-email flow: Failed OTP attempt recorded.";

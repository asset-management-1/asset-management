...
public class AuthenticationEntityMapping : IRegister
{
    ...
    public void Register(TypeAdapterConfig config)
    {
        ...
        // Profile update is partial; phone, avatar, and gender stay service-owned for validation, upload, and lookup flows.
        config.NewConfig<UpdateUserInfoRequestDto, User>()
            .IgnoreNullValues(true)
            .Ignore(dest => dest.PhoneNumber)
            .Ignore(dest => dest.AvatarUrl)
            .Ignore(dest => dest.GenderId)

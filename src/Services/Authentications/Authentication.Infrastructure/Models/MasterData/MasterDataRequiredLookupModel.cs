...
/// <summary>
/// Groups the lookup and error metadata required to resolve one mandatory master-data value.
/// </summary>
internal sealed class MasterDataRequiredLookupModel
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MasterDataRequiredLookupModel"/> class.
    /// </summary>
    ...
    public MasterDataRequiredLookupModel(
        string type,
        string value,
        string message,
